...
# -*- coding: utf-8 -*-
"""
News Analyst 的 MemoryManager。

说明：
    - 继承自 BaseAnalystMemoryManager
    - 使用 news_summary.j2 Prompt 模板生成 7 日窗口的结构化 summary
"""
...
class NewsMemoryManager(BaseAnalystMemoryManager):
    """News Analyst 的 MemoryManager。"""

    def __init__(self, db_helper: Any, date_resolver: Optional[Any] = None) -> None:
        super().__init__(analyst_type="news", db_helper=db_helper, date_resolver=date_resolver)
    ...
    def _generate_summary_with_llm(
        ...
        """使用 LLM 生成 7 日窗口的结构化 News summary。
        ...
        """
        # 1. 加载 Prompt 模板
        prompt_path = Path(__file__).parent / "prompts" / "news_summary.j2"
