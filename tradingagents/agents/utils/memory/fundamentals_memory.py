...
# -*- coding: utf-8 -*-
"""
Fundamentals Analyst 的 MemoryManager。

说明：
    - 继承自 BaseAnalystMemoryManager
    - 使用 fundamentals_summary.j2 Prompt 模板生成 7 日窗口的结构化 summary
"""
...
class FundamentalsMemoryManager(BaseAnalystMemoryManager):
    """Fundamentals Analyst 的 MemoryManager。"""
    ...
    def _generate_summary_with_llm(
        ...
        """使用 LLM 生成 7 日窗口的结构化 Fundamentals summary。
        ...
        """
        # 1. 加载 Prompt 模板
        prompt_path = Path(__file__).parent / "prompts" / "fundamentals_summary.j2"
        ...
        try:
            ...
            # 验证关键字段是否为空
            if not parsed_json.get("symbol") or parsed_json.get("has_fundamental_change") is None:
